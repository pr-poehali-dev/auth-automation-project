...
import { 
  BarChart3, UserPlus, Bell, AlertTriangle, FileText, DollarSign, 
  Users, LogOut, Home, HelpCircle, User, UserCog, MessageCircle, PhoneCall 
} from "lucide-react";
...
const Dashboard = () => {
  ...
  const stats = [
    { id: 1, title: "Всего пользователей", value: "124", icon: Users, change: "+12%", trend: "up" },
    { id: 2, title: "Выговоров (месяц)", value: "8", icon: AlertTriangle, change: "-5%", trend: "down" },
    { id: 3, title: "Логи (месяц)", value: "472", icon: FileText, change: "+18%", trend: "up" },
    { id: 4, title: "Общий заработок", value: "248,500₽", icon: DollarSign, change: "+14%", trend: "up" },
  ];
      ...
      <aside className="w-64 bg-card border-r flex flex-col">
        ...
        <nav className="flex-1 overflow-y-auto p-2">
          <div className="space-y-1">
            ...
            <p className="text-xs font-semibold text-muted-foreground px-3 pt-4 pb-1">АДМИНИСТРИРОВАНИЕ</p>
            <Button variant="ghost" className="w-full justify-start gap-2">
            ...
            <p className="text-xs font-semibold text-muted-foreground px-3 pt-4 pb-1">ПОЛЬЗОВАТЕЛИ</p>
            <Button variant="ghost" className="w-full justify-start gap-2">
        ...
        <header className="border-b bg-card p-4 flex items-center justify-between sticky top-0 z-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-sm hidden md:block">Администратор</span>
            </div>
          </div>
        </header>
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-muted-foreground">Управляйте пользователями и отслеживайте статистику</p>
            </div>
